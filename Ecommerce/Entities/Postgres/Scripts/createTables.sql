...
CREATE TABLE IF NOT EXISTS addresses(
	...
	building_number varchar(512) NOT NULL,
...
CREATE TABLE IF NOT EXISTS product_categories_membership(
...
CREATE TABLE IF NOT EXISTS orders(
	...
	FOREIGN KEY (payment_detail_id) REFERENCES payment_details(id) ON DELETE NO ACTION,
	FOREIGN KEY (shipping_address_id) REFERENCES addresses(id) ON DELETE SET NULL,
	FOREIGN KEY (shipping_method_id) REFERENCES shipping_methods(id) ON DELETE NO ACTION
);
...
INSERT INTO product_categories(name) VALUES ('Electronics'), ('Smartphones'), ('Laptops'), ('Cameras'), ('Headphones'), 
...
INSERT INTO order_statuses(name) VALUES ('Pending'), ('Processing'), ('Shipped'), ('Delivered'), ('Completed'), ('Canceled'), ('Returned'), ('Refunded'), ('Error');
INSERT INTO payment_methods(name) VALUES ('Credit Card'), ('Debit Card'), ('PayPal'), ('Bank Transfer'), ('Cash on Delivery');
INSERT INTO payment_statuses(name) VALUES ('Pending'), ('Authorized'), ('Charged'), ('Declined'), ('Refunded'), ('Canceled'), ('Error');
INSERT INTO shipping_methods(name, price) VALUES ('FedEx', 25), ('DHL', 30), ('Amazon', 20), ('In-Store Pickup', 0), ('Parcel Pickup', 10);

INSERT INTO countries(country_code, name, code) VALUES ('AFG','Afghanistan','AF'),
('ALA','Åland','AX'),
('ALB','Albania','AL'),
('DZA','Algeria','DZ'),
